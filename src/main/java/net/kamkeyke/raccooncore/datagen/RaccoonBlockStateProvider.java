...
public abstract class RaccoonBlockStateProvider extends BlockStateProvider {
    protected final String modid;

    public RaccoonBlockStateProvider(PackOutput output, String modid, ExistingFileHelper exFileHelper) {
